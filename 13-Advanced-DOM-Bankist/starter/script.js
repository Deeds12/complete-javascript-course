...
const alertH1 = function (e) {
  alert('addEveventListener: Grate! You are reading the heading');
};
// Novi nacin
...
// Ceating and inserting elements
...
document
  ...
  .addEventListener('click', function () {
    // Old way of selecting child element by treversing DOM tree
...
/* h1.onmouseenter = function (e) {
  alert('onmouseenter: Grate! You are reading the heading');
}; */
